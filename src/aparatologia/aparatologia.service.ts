...
export class AparatologiaService {
    ...
    /**
     * Muestra todas las aparatologias de la BD que correspondan a un pagos de un medico de algun dia y turno
     * turno:
     *  1 = MATUTINO
     *  2 = VESPERTINO
     */
    async findAparatologiaByPayOfDoctorTurno(anio, mes, dia, sucursalId, medicoId, atendidoId, turno): Promise<AparatologiaI[]> {
        let startDate = new Date(anio, mes, dia);
